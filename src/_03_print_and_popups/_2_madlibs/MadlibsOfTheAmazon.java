...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String inputBodyPart = JOptionPane.showInputDialog("Enter a body part.");
		...
		String story = 
		"Piranhas are more " + inputAdjective + " during the day, so cross the river at\n"  +
		"night. Piranhas are attracted to fresh " + inputLiquid + " and will most\n"  +
		"likely take a bite out of your " + inputBodyPart + " if you " + inputVerb+ "." + " Whatever\n"  +
		"you do, if you have an open wound, try to find another way to get\n"  +
		"back to the " + inputPlace + "." + " Good luck!";
